...
interface UseVoiceConversationReturn {
    ...
    /** MediaStream ref for recording (available after start()) */
...
declare const VAD_COOLDOWN_MS = 400;
...
type DisplayState = "connecting" | "listening" | "recording" | "processing" | "speaking" | "interrupted";
...
type WaveformSize = "sm" | "md" | "lg" | number;
...
declare const VoiceWaveform: React$1.NamedExoticComponent<VoiceWaveformProps>;
...
/**
 * Barge-in / Interruption icon - raised hand style
 */
declare function BargeInIcon({ size, color, className }: IconProps): react_jsx_runtime.JSX.Element;
/**
 * VAD Meter icon - audio level indicator
 */
interface VADMeterIconProps extends IconProps {
    /** Audio level from 0 to 1 */
    level?: number;
    /** Number of bars (default 5) */
    barCount?: number;
    /** Active color for lit bars */
    activeColor?: string;
    /** Inactive color for unlit bars */
    inactiveColor?: string;
}
declare function VADMeterIcon({ size, color, level, barCount, activeColor, inactiveColor, className, }: VADMeterIconProps): react_jsx_runtime.JSX.Element;
/**
 * Animated VAD meter that responds to audio level
 */
interface AnimatedVADMeterProps extends Omit<VADMeterIconProps, "level"> {
    /** Audio level from 0 to 1, updated in real-time */
    level: number;
    /** Whether the meter is active/visible */
    isActive?: boolean;
}
declare function AnimatedVADMeter({ size, level, barCount, activeColor, inactiveColor, isActive, className, }: AnimatedVADMeterProps): react_jsx_runtime.JSX.Element | null;
