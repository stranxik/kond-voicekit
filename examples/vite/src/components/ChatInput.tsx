...
import { VoiceStatusIndicator, VoiceWaveform } from "@kond.studio/voicekit/react";
...
export function ChatInput({
  ...
  const showWaveform = isActive && userSpeaking;
  ...
  return (
    <div className="input-area">
      <div className="input-container">
        {/* Status Indicator with premium animations */}
